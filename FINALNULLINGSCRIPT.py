...
#cims_df = pd.read_csv('C:\Users\mbdxkame\Documents\Beijing\minuteaverageddatamarch17\\morecims\species.csv')

cims_df = pd.read_csv('C:\Users\mbdxkame\Documents\Beijing\minuteaverageddatamarch17\named\\allnamedspecies.csv')
#pythontime = cims_df['pythontime'] #defined excel column names to variables 
#Initric = cims_df['Initric']
#Iformic = cims_df['Iformic']
Iisoprenenitrate = cims_df['Iisoprenenitrate']
...
table_df = pd.DataFrame(
    { 'time4': time4,
     'Iisoprenenitrate' : Iisoprenenitrate, 
    })
...
#df3.to_csv('C:\Users\mbdxkame\Documents\Beijing\minuteaverageddatamarch17\morecims\newlist.csv')
